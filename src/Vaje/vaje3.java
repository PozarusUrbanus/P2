...
public class vaje3 {
    ...
    public static void izpisi16bit(short[] nizZnakov) {
        for (int i = 3; i >= 0; i--) {
            for (int k = 0; k < nizZnakov.length; k++) {
                for (int j = 3; j >= 0; j--) {
                    int maska = 1<<(i * 4 + j);
                    int rezultat = nizZnakov[k] & maska;
                    if (rezultat != 0) {
                        System.out.print(crnaPika);
                    }else {
                        System.out.print(belaPika);
    ...
    public static void izpisi16bit(String niz) {
        ...
        for (int i = 0; i < niz.length(); i++) {
            ...
            for (int j = 0; j < kodeZnakov16bit.length; j++) {
                if (j == indeks) {
    ...
    private static final long[] kodeZnakov64bit = {
            ...
            0b0111111010000001000000010000011000011000011000011000000111111111L,    //2                                                            // TODO: dodaj znak 2
            ...
            0b0011000001111000011110000011000000110000000000000011000000000000L,
            0b0010010000011000000000000011110000100000001111000000010000111100L,
    ...
    public static void izpisi64bit(long[] nizZnakov) {
        for (int i = 7; i >= 0; i--) {
            for (int k = 0; k < nizZnakov.length; k++) {
                for (int j = 7; j >= 0; j--) {
                    long maska = 1L<<(i * 8 + j);
                    long rezultat = nizZnakov[k] & maska;
                    if (rezultat != 0) {
                        System.out.print(crnaPika);
                    }else {
                        System.out.print(belaPika);
    ...
    public static void izpisi64bit(String niz){
        ...
        for (int i = 0; i < niz.length(); i++) {
            ...
            for (int j = 0; j < kodeZnakov64bit.length; j++) {
                if (j == indeks) {
